...
export class Learn2018Helper {
  ...
  async getUserInfo() {
    let courseType = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : CourseType.STUDENT;
  ...
  async getCourseList(semesterID) {
    let courseType = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : CourseType.STUDENT;
  ...
  async getAllContents(courseIDs, type) {
    let courseType = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : CourseType.STUDENT;
