...
export const LEARN_HOMEWORK_PAGE = (courseID, id) => `${LEARN_PREFIX}/f/wlxt/kczy/zy/student/viewCj?wlkcid=${courseID}&xszyid=${id}`;
export const LEARN_HOMEWORK_EXCELLENT_PAGE = (courseID, id) => `${LEARN_PREFIX}/f/wlxt/kczy/zy/student/viewYxzy?wlkcid=${courseID}&xszyid=${id}`;
export const LEARN_HOMEWORK_DETAIL = `${LEARN_PREFIX}/b/wlxt/kczy/zy/student/detail`;
export const LEARN_HOMEWORK_DETAIL_FORM_DATA = baseId => {
  const form = new FormData();
