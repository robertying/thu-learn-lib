...
export const LEARN_FILE_PREVIEW = function (type, fileID, courseType) {
...
export const LEARN_HOMEWORK_SUBMIT_FORM_DATA = function (studentHomeworkID) {
...
export const LEARN_DISCUSSION_DETAIL = function (courseID, boardID, discussionID, courseType) {
...
export const REGISTRAR_CALENDAR = function (startDate, endDate) {
