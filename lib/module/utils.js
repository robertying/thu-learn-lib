...
import { ContentType, FailReason, HomeworkGradeLevel, QuestionnaireType, SemesterType } from "./types.js";
...
export function replaceLatexWithSource(result) {
...
export const CONTENT_TYPE_MAP = new Map([[ContentType.NOTIFICATION, 'KCGG'], [ContentType.FILE, 'KCKJ'], [ContentType.HOMEWORK, 'KCZY'], [ContentType.DISCUSSION, 'KCTL'], [ContentType.QUESTION, 'KCDY'], [ContentType.QUESTIONNAIRE, 'KCWJ']
// omitted: 课表(KCKB)
]);
export const CONTENT_TYPE_MAP_REVERSE = new Map([[CONTENT_TYPE_MAP.get(ContentType.NOTIFICATION), ContentType.NOTIFICATION], [CONTENT_TYPE_MAP.get(ContentType.FILE), ContentType.FILE], [CONTENT_TYPE_MAP.get(ContentType.HOMEWORK), ContentType.HOMEWORK], [CONTENT_TYPE_MAP.get(ContentType.DISCUSSION), ContentType.DISCUSSION], [CONTENT_TYPE_MAP.get(ContentType.QUESTION), ContentType.QUESTION], [CONTENT_TYPE_MAP.get(ContentType.QUESTIONNAIRE), ContentType.QUESTIONNAIRE]]);
export const QNR_TYPE_MAP = new Map([['投票', QuestionnaireType.VOTE], ['填表', QuestionnaireType.FORM], ['问卷', QuestionnaireType.SURVEY]]);
