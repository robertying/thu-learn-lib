...
export declare const LEARN_HOMEWORK_SUBMIT_PAGE: (courseID: string, studentHomeworkID: string) => string;
export declare const LEARN_HOMEWORK_SUBMIT: () => string;
export declare const LEARN_HOMEWORK_SUBMIT_FORM_DATA: (studentHomeworkID: string, content?: string, attachment?: IHomeworkSubmitAttachment, removeAttachment?: boolean) => FormData;
